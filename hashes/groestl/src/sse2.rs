...
unsafe fn round(i: i64, a: X8) -> X8 {
    ...
    let a0 = _mm_shuffle_epi8(a0, _mm_set_epi64x(0x03060a0d08020509, 0x0c0f0104070b0e00));
    let a1 = _mm_shuffle_epi8(a1, _mm_set_epi64x(0x04070c0f0a03060b, 0x0e090205000d0801));
    let a2 = _mm_shuffle_epi8(a2, _mm_set_epi64x(0x05000e090c04070d, 0x080b0306010f0a02));
    let a3 = _mm_shuffle_epi8(a3, _mm_set_epi64x(0x0601080b0e05000f, 0x0a0d040702090c03));
    let a4 = _mm_shuffle_epi8(a4, _mm_set_epi64x(0x0702090c0f060108, 0x0b0e0500030a0d04));
    let a5 = _mm_shuffle_epi8(a5, _mm_set_epi64x(0x00030b0e0907020a, 0x0d080601040c0f05));
    let a6 = _mm_shuffle_epi8(a6, _mm_set_epi64x(0x01040d080b00030c, 0x0f0a0702050e0906));
    let a7 = _mm_shuffle_epi8(a7, _mm_set_epi64x(0x02050f0a0d01040e, 0x090c000306080b07));
    let b0 = _mm_cvtsi64_si128(0);
    let aa = (
        _mm_aesenclast_si128(a0, b0),
        _mm_aesenclast_si128(a1, b0),
        _mm_aesenclast_si128(a2, b0),
        _mm_aesenclast_si128(a3, b0),
        _mm_aesenclast_si128(a4, b0),
        _mm_aesenclast_si128(a5, b0),
        _mm_aesenclast_si128(a6, b0),
        _mm_aesenclast_si128(a7, b0),
    );
    // MixBytes
    mix_bytes(aa)
}
...
#[inline(always)]
unsafe fn init_impl(cv: [__m128i; 4]) -> [__m128i; 4] {
